...
input.addEventListener("keypress", function(event) {
  ...
  if (event.key === "Enter") {
    ...
    if (codeToCheck == "vitamason") { // No Rehearsal No +1
      window.location.href = "main.html?code=vitamason";  // Replace with your custom page URL
    } else if (codeToCheck == "vitamason-rd") { // Rehearsal No +1
      window.location.href = "main.html?code=vitamason-rd";  // Replace with your custom page URL
    } else if (codeToCheck == "vitamason-g") { // No Rehearsal + 1
      window.location.href = "main.html?code=vitamason-g";  // Replace with your custom page URL
    } else if (codeToCheck == "vitamason-rdg") { // Rehearsal + 1
      window.location.href = "main.html?code=vitamason-rdg";  // Replace with your custom page URL
    } else {
      warning.style.visibility = "visible";
    }
  }
